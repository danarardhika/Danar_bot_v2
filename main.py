...
"""
Bot Saham Danar v2.4 - Dengan Force Refresh & Real-time Price
"""
...
# Cache duration (default 5 menit, bisa diubah)
...
class Screener:
    ...
    def get_stock_data(self, symbol, period='1mo', max_retries=2, force_refresh=False):
        """
        Ambil data saham dengan cache.
        Jika force_refresh=True, skip cache dan ambil data baru.
        """
        cache_key = f"{symbol}_{period}"
        
        # SKIP CACHE jika force_refresh = True
...
class SahamBot:
    ...
    async def refresh_price(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            # Force refresh dengan skip cache
    ...
    async def force_refresh_all(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # Ambil ulang data untuk semua watchlist
            success_count = 0
            fail_count = 0
    ...
    async def chart_custom(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        if not context.args:
            await update.message.reply_text(
                ...
                "/cc BUMI - Chart BUMI\n"
                "/cc ADRO - Chart ADRO\n\n"
                "Alias: /chart_custom, /chartcustom, /customchart, /cc\n\n"
    ...
    def run(self):
        try:
            ...
            application.add_handler(CommandHandler("rp", self.refresh_price))  # alias
            application.add_handler(CommandHandler("force_refresh", self.force_refresh_all))
            application.add_handler(CommandHandler("fr", self.force_refresh_all))  # alias
            ...
            # Print banner
            print("=" * 60)
            print("🤖 BOT SAHAM DANAR v2.4 - DENGAN FORCE REFRESH")
            print("=" * 60)
            print(f"📌 Token: ✓")
            ...
            print("💡 Contoh: /rp BBCA, /cc BUMI, /cc ADRO")
            print("=" * 60)
