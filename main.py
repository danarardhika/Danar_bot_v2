...
"""
Bot Saham Danar v2.4 - Dengan Alias Command
"""
...
class SahamBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        await update.message.reply_text(
            ...
            "/chartcustom SYMBOL - Sama dengan di atas\n"
    ...
    async def chart_custom(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if not context.args:
            await update.message.reply_text(
                "❌ *Gunakan:* /chart_custom SYMBOL\n\n"
                "📌 *Contoh:* /chart_custom BBCA\n\n"
                "📊 *Alias yang tersedia:*\n"
                "• /chart_custom BBCA\n"
                "• /chartcustom BBCA\n"
                "• /cc BBCA\n\n"
    ...
    def run(self):
        try:
            ...
            application.add_handler(CommandHandler("chartcustom", self.chart_custom))   # tanpa underscore
            application.add_handler(CommandHandler("customchart", self.chart_custom))   # versi lain
            application.add_handler(CommandHandler("cc", self.chart_custom))            # singkatan
            # =====================================================
            ...
            print("=" * 60)
            print("🤖 BOT SAHAM DANAR v2.4 - ALIAS COMMAND")
            print("=" * 60)
            print(f"📌 Token: ✓")
            print(f"📌 Watchlist: {len(self.watchlist)} saham")
            print(f"📌 Chart Custom: Aktif")
            print(f"📌 Alias: /chart_custom, /chartcustom, /cc")
            print("=" * 60)
